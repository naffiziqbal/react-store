...
const Product = ({ product }) => {
  ...
  return (
    <div className="border-amber-300 border rounded-md   h-full flex flex-col  justify-end">
      ...
      <h1> <strong> Description:  </strong> {description.length === 100 ? description : description.slice(0, 100) } ....</h1>
      <h1> <strong> Category  </strong> {category}</h1>
      </div>
      
      </div>
      <button className="w-full bg-orange-400 text-lg text-white rounded-md  p-1">Add To Cart</button>
